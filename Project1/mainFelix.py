...
import BDF4Solver
exp_sim_bdf4 = BDF4Solver.BDF4(eP_Problem) #Create a BDF solver
exp_sim_bdf4.reset()
print(exp_sim_bdf4.maxsteps)
t_bdf4, y_bdf4 = exp_sim_bdf4.simulate(simulation_time)

#BDF2Solver
import BDF2Solver 
exp_sim_bdf2 = BDF2Solver.BDF_2(eP_Problem) #Create a BDF solver
exp_sim_bdf2.reset()
t_bdf2, y_bdf2 = exp_sim_bdf2.simulate(simulation_time, communication_points)

#EESolver
import EESolver
exp_sim_ee = EESolver.Explicit_Euler(eP_Problem) #Create a BDF solver
exp_sim_ee.reset()
t_ee, y_ee = exp_sim_ee.simulate(simulation_time, communication_points)

# Plot Results - All in one figure with 2x2 grid
fig, axes = plt.subplots(2, 2, figsize=(14, 10))
fig.suptitle(eP_Problem.name, fontsize=14, fontweight='bold')

# CVode (top-left)
axes[0, 0].plot(t_sol, x_sol[:,0], label=r'$x(t)$')
axes[0, 0].plot(t_sol, x_sol[:,1], label=r'$y(t)$')
axes[0, 0].plot(t_sol, x_sol[:,2], label=r'$v_x(t)$')
axes[0, 0].plot(t_sol, x_sol[:,3], label=r'$v_y(t)$')
axes[0, 0].set_xlabel('t')
axes[0, 0].set_ylabel('state value')
axes[0, 0].legend()
axes[0, 0].set_title('CVode (adaptive)')
axes[0, 0].grid(True)

# BDF4 (top-right)
axes[0, 1].plot(t_bdf4, y_bdf4[:,0], label=r'$x(t)$')
axes[0, 1].plot(t_bdf4, y_bdf4[:,1], label=r'$y(t)$')
axes[0, 1].plot(t_bdf4, y_bdf4[:,2], label=r'$v_x(t)$')
axes[0, 1].plot(t_bdf4, y_bdf4[:,3], label=r'$v_y(t)$')
axes[0, 1].set_xlabel('t')
axes[0, 1].set_ylabel('state value')
axes[0, 1].legend()
axes[0, 1].set_title(f'BDF4 (h={exp_sim_bdf4.h})')
axes[0, 1].grid(True)

# BDF2 (bottom-left)
axes[1, 0].plot(t_bdf2, y_bdf2[:,0], label=r'$x(t)$')
axes[1, 0].plot(t_bdf2, y_bdf2[:,1], label=r'$y(t)$')
axes[1, 0].plot(t_bdf2, y_bdf2[:,2], label=r'$v_x(t)$')
axes[1, 0].plot(t_bdf2, y_bdf2[:,3], label=r'$v_y(t)$')
axes[1, 0].set_xlabel('t')
axes[1, 0].set_ylabel('state value')
axes[1, 0].legend()
axes[1, 0].set_title(f'BDF2 (h={exp_sim_bdf2.h})')
axes[1, 0].grid(True)

# EE (bottom-right)
axes[1, 1].plot(t_ee, y_ee[:,0], label=r'$x(t)$')
axes[1, 1].plot(t_ee, y_ee[:,1], label=r'$y(t)$')
axes[1, 1].plot(t_ee, y_ee[:,2], label=r'$v_x(t)$')
axes[1, 1].plot(t_ee, y_ee[:,3], label=r'$v_y(t)$')
axes[1, 1].set_xlabel('t')
axes[1, 1].set_ylabel('state value')
axes[1, 1].legend()
axes[1, 1].set_title(f'Explicit Euler (h={exp_sim_ee.h})')
axes[1, 1].grid(True)

plt.tight_layout()
save_path = '/Users/felixsjoholm/Documents/Kurser/Simuleringsverktyg/SimToolsProj1/Project1/elastic_pendulum_comparison.png'
...
plt.legend()
save_path = '/Users/felixsjoholm/Documents/Kurser/Simuleringsverktyg/SimToolsProj1/Project1/elastic_pendulum_accuracy_comparison.png'
plt.savefig(save_path, dpi=300, bbox_inches='tight')
print(f"Accuracy comparison figure saved to: {save_path}")
plt.show()
...
plt.grid(True, which="both", ls="--")
plt.legend()
save_path = '/Users/felixsjoholm/Documents/Kurser/Simuleringsverktyg/SimToolsProj1/Project1/elastic_pendulum_stability_comparison.png'
plt.savefig(save_path, dpi=300, bbox_inches='tight')
print(f"Stability comparison figure saved to: {save_path}")
plt.show()
